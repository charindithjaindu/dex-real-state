...
let start_day = "01/07/2024"; // m/d/y
...
$('.btn-deposit').click(function(){
    ...
    if (plan == 0) {
        var amount = '3300000';
        var textd = "Buy (0.33% $UTOPIA)";
    }
    if (plan == 1) {
        var amount = '5500000';
      var textd = "Buy (0.55% $UTOPIA)";
    }
    if (plan == 2) {
        var amount = '8800000';
      var textd = "Buy (0.88% $UTOPIA)";
    }
    if (plan == 3) {
        var amount = '13200000';
      var textd = "Buy (1.32% $UTOPIA)";
    }
...
async function getAccountDetails() {
    ...
    if(status == 'connected') {
        ...
        var reflink = document.getElementById('reflink');
        reflink.setAttribute("value", 'https://app.UTOPIAX.pro/?ref='+address);
