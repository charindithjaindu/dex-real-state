...
var contract_1;
var address_1 = "0xf3892F014dBEb49606A45c4DdfFa7002274C1B6c";
...
var token_1;
var token_address_1 = "0x8b7C7A811F01f67DB62619d056064074497176Bb";
...
$('.btn-deposit').click(function(){
    ...
    if (plan == 0) {
        var amount = '3300000';
        var textd = "Buy (0.33% Propify)";
    }
    if (plan == 1) {
        var amount = '5500000';
        var textd = "Buy (0.55% Propify)";
    }
    if (plan == 2) {
        var amount = '8800000';
        var textd = "Buy (0.88% Propify)";
    }
    if (plan == 3) {
        var amount = '13200000';
        var textd = "Buy (1.32% Propify)";
    }
...
async function getAccountDetails() {
    ...
    if(status == 'connected') {
        ...
        var reflink = document.getElementById('reflink');
        reflink.setAttribute("value", 'https://propify.one/?ref='+address);
